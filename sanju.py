...
TOKEN = '7663447666:AAHXagBlW2G0dJt8RPl_dZ_XpEEP2x7bvq0'  # Replace with your actual bot token
ADMIN_IDS = [5712886230]  # Added new admin ID
CHANNEL_ID = '-1002488661685' # Replace with your specific channel or group ID
# Initialize the bot
...
EXEMPTED_USERS = [5712886230,5575401798]
...
def show_help(message):
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬:* [⚡  ┊𝐕𝘪c𝕜𝘆 x Š₳₦JU┊](https://t.me/vicky08oct10) 💀\n"
    )
...
FEEDBACK_CHANNEL_ID = "-1002488661685"  # Replace with your actual feedback channel ID
...
PRIVATE_CHANNEL_USERNAME = "vicky08oct10"  # Example: "MyPrivateChannel"
PRIVATE_CHANNEL_LINK = "https://t.me/vicky08oct10"  # Replace with actual link
...
# Check if the number of running attacks is at the limit
    ...
    if user_id not in EXEMPTED_USERS:
        ...
        if user_id in user_cooldowns:
            ...
            if datetime.now() < cooldown_time:
                ...
                bot.send_message(
                    message.chat.id,
                    f"⚠️⚠️ 𝙃𝙞 {message.from_user.first_name}, 𝙮𝙤𝙪 𝙖𝙧𝙚 𝙘𝙪𝙧𝙧𝙚𝙣𝙩𝙡𝙮 𝙤𝙣 𝙘𝙤𝙤𝙡𝙙𝙤𝙬𝙣. 𝙋𝙡𝙚𝙖𝙨𝙚 𝙬𝙖𝙞𝙩 {remaining_time // 2} 𝙢𝙞𝙣𝙪𝙩𝙚𝙨 𝙖𝙣𝙙 {remaining_time % 2} 𝙨𝙚𝙘𝙤𝙣𝙙𝙨 𝙗𝙚𝙛𝙤𝙧𝙚 𝙩𝙧𝙮𝙞𝙣𝙜 𝙖𝙜𝙖𝙞𝙣 ⚠️⚠️ "
                )
                return
        ...
        if user_attacks[user_id] >= DAILY_ATTACK_LIMIT:
            bot.send_message(
                message.chat.id,
                f"𝙃𝙞 {message.from_user.first_name}, YOUR ATTACK LIMIT REACHED PLAY TOMORROW ✌️"
            )
            return
        ...
        if user_id in user_attacks and user_attacks[user_id] > 0 and not user_photos.get(user_id, False):
            ...
            bot.send_message(
                message.chat.id,
                f"𝙃𝙞 {message.from_user.first_name}, ⚠️💀 YOU DIDN'T SEND FEEDBACK.\n\n 𝙔𝙤𝙪 𝙖𝙧𝙚 𝙗𝙖𝙣𝙣𝙚𝙙 𝙛𝙧𝙤𝙢 𝙪𝙨𝙞𝙣𝙜 𝙩𝙝𝙞𝙨 𝙘𝙤𝙢𝙢𝙖𝙣𝙙 𝙛𝙤𝙧 10 𝙢𝙞𝙣𝙪𝙩𝙚𝙨 ⚠️⚠️"
            )
            return
    ...
    try:
        ...
        if len(args) != 3:
            raise ValueError(" ┊𝐕𝘪c𝕜𝘆 x Š₳₦JU┊™ D-dos✅ \n\n⚙ USE THIS 👇⬇️\n/TF <IP> <PORT> <DURATION>")
